...
import type { Category as _Category, Order as _Order, OrderId as _OrderId, OrderItem as _OrderItem, OrderStatus as _OrderStatus, Product as _Product, ProductId as _ProductId, ProductImage as _ProductImage, ProductInput as _ProductInput, ShippingAddress as _ShippingAddress, SortOption as _SortOption, StripeSessionStatus as _StripeSessionStatus, Timestamp as _Timestamp, UserId as _UserId, UserProfile as _UserProfile, UserRole as _UserRole, _ImmutableObjectStorageRefillInformation as __ImmutableObjectStorageRefillInformation, _ImmutableObjectStorageRefillResult as __ImmutableObjectStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addToCart(arg0: ProductId, arg1: bigint): Promise<CartSummary> {
        if (this.processError) {
            try {
    ...
    async listProducts(arg0: Category | null, arg1: string | null, arg2: SortOption | null): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.listProducts(to_candid_opt_n32(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n33(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n34(this._uploadFile, this._downloadFile, arg2));
    ...
    async removeFromCart(arg0: ProductId): Promise<CartSummary> {
        if (this.processError) {
            try {
    ...
    async updateCartItemQuantity(arg0: ProductId, arg1: bigint): Promise<CartSummary> {
        if (this.processError) {
            try {
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "watches" in value ? Category.watches : "bags" in value ? Category.bags : "clothes" in value ? Category.clothes : "shoes" in value ? Category.shoes : "computers" in value ? Category.computers : "electronics" in value ? Category.electronics : value;
}
...
function to_candid_SortOption_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SortOption): _SortOption {
...
function to_candid_opt_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Category | null): [] | [_Category] {
...
function to_candid_opt_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SortOption | null): [] | [_SortOption] {
    return value === null ? candid_none() : candid_some(to_candid_SortOption_n35(_uploadFile, _downloadFile, value));
}
...
function to_candid_variant_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SortOption): {
    newest: null;
} | {
    priceDesc: null;
} | {
    ...
    return value == SortOption.newest ? {
        newest: null
